...
vim.keymap.set('n', '[d', function () vim.diagnostic.jump({count = -1}) end, { desc = "Diagnostics: goto_prev" })
vim.keymap.set('n', ']d', function () vim.diagnostic.jump({count = 1}) end, { desc = "Diagnostics: goto_next" })
